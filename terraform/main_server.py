...
class ServerStack(TerraformStack):
    ...
    def __init__(self, scope: Construct, id: str):
        ...
        lab_instance_profile = DataAwsIamInstanceProfile(
            self, "existing_instance_profile",
